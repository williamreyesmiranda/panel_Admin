    ...
    <tbody>
        ...
        ?>
            <tr>
                ...
                <td>
                    <h5>
                        <a class="my-auto" title=" Editar pedido" data-toggle="modal" data-target="#modalEditarPedido"><i class="fas fa-edit a-text-kmisetas my-auto" onclick="agregaForm('<?php echo ($datos); ?>')"></i></a>
                        <a class="my-auto" title="Cambiar Procesos" data-toggle="modal" data-target="#modalEditarProceso"><i class="fas fa-cut a-text-kmisetas my-auto"></i></a>
