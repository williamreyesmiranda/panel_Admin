        ...
        <main>
            <div class="container-fluid">
                <ol class="breadcrumb mb-3 mt-3">
                    ...
                    <li class="breadcrumb-item active">Lista Colores</li>
                </ol>
                ...
                <div class="card mb-4">
                    <div class="card-header ">
                        <div class="card-body d-flex justify-content-between align-items-center p-0">
                            Lista Colores
                            <a href="#" class="btn btn-dark btn-sm" data-toggle="modal" data-target="#ingresarColor">Ingresar Color</a>
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <div class="tablaColores"></div>
                        </div>
                    </div>
                </div>
            </div>
