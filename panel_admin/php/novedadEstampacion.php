...
$destinatario = $correoAsesor; 
    ...
    $consultaSQL="INSERT INTO novedades(idPedido, area, novedad, usuario) VALUES ('$idPedido','estampacion','$novedad','$idUsuario');
                  ";
...
$consultaSQL="UPDATE estampacion SET numNovedad='$maxNovedad' WHERE pedido='$idPedido'";
$result=$conexion->editarDatos($consultaSQL);
$destinatario = $correoAsesor; 
