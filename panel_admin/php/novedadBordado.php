...
$destinatario = $correoAsesor; 
    ...
    $consultaSQL="INSERT INTO novedades(idPedido, area, novedad, usuario) VALUES ('$idPedido','bordado','$novedad','$idUsuario');
                  ";
...
$consultaSQL="UPDATE bordado SET numNovedad='$maxNovedad' WHERE pedido='$idPedido'";
$result=$conexion->editarDatos($consultaSQL);
$destinatario = $correoAsesor; 
