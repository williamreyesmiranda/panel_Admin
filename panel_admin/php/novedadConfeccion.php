...
$destinatario = $correoAsesor; 
    ...
    $consultaSQL="INSERT INTO novedades(idPedido, area, novedad, usuario) VALUES ('$idPedido','confeccion','$novedad','$idUsuario');
                  ";
...
//ingreso del ultimo id ingresado a confeccion
$consultaSQL="UPDATE confeccion SET numNovedad='$maxNovedad' WHERE pedido='$idPedido'";
$result=$conexion->editarDatos($consultaSQL);
$destinatario = $correoAsesor; 
