            ...
            <ol class="breadcrumb mb-3 mt-3">
                ...
                <div class="accordion" id="accordionExample">
                    ...
                    <div class="card-body d-flex text-center justify-content-between align-items-center p-0">
                            <h1 class="text-center">INFORME DE SUBLIMACIÓN <?php echo date('d-m-Y');?></h1>
                            <a href="excelReporteSublimacion.php" title="Exportar a Excel" class="text-dark text-lg"><h2><i class="far fa-file-excel"></i></h2></a>
                        </div>
                    </div>
