        ...
        <main>
            <div class="container-fluid">
                <ol class="breadcrumb mb-3 mt-3">
                    ...
                    <li class="breadcrumb-item "><a class="a-text-kmisetas" href="listaBordado.php">Lista Bordado</a></li>
                    <li class="breadcrumb-item active">Reporte Bordado</li>
                </ol>
                <?php
                $hoy = date('Y-m-d');
                ...
                <div class="accordion" id="accordionExample">
                    ...
                    <div class="alert alert-secondary">
                        <div class="card-body d-flex text-center justify-content-between align-items-center p-0">
                            ...
                            <a href="excelReporteBordado.php" title="Exportar a Excel" class="text-dark text-lg"><h2><i class="far fa-file-excel"></i></h2></a>
                        </div>
