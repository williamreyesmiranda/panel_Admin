...
*/
(function(b) {
    "function" === typeof define && define.amd ? define(["jquery", "datatables.net", "datatables.net-buttons"], function(c) { return b(c, window, document) }) : "object" === typeof exports ? module.exports = function(c, g) {
        c || (c = window);
    ...
    u.ext.buttons.print = {
        ...
        text: function(a) { return a.i18n("buttons.print", "Imprimir") },
