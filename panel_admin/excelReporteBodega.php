    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid">
                ...
                <div class="accordion" id="accordionExample">
                    ...
                    <div class="breadcrumb mb-3 mt-3 px-0 h-100">
                        ...
                        <div class="col-xl-3 col-md-6 mb-2" style="border:1px solid black">ATRASADOS
                            <div class="card h-100 bg-danger text-white mb-1" >
                                <?php
                                $consultaSQL = "SELECT count(bo.idbodega) as 'contar', sum(pe.unds) as 'unds', sum(bo.parcial) as 'parcial'  FROM bodega bo
                                ...
                                $falta = $unds - $parcial;
                                ?>
                                <div class="card-header bg-danger"><?php echo $contar . " pedidos.  (" . $unds . " unds). <br> Unds Listas: " . $parcial . ". <br> Unds Faltantes: " . $falta; ?>
                                </div>
                            </div>
                    ...
                    <div class="col-xl-3 col-md-6 mb-2" style="border:1px solid black">0 A 3 DIAS
                        <div class="card h-100 bg-warning text-dark mb-1">
                            ...
                            $falta = $unds - $parcial;
                            ?>
                            <div class="card-header"><?php echo $contar . " pedidos.  (" . $unds . " unds). <br> Unds Listas: " . $parcial . ". <br> Unds Faltantes: " . $falta; ?>
                            </div>
                ...
                <div class="collapse show" id="pedidosAtrasados" data-parent="#accordionExample">
                    <div class="container">
                                    ...
                                    <div class="card-body">
                                        <table class="table table-hover table-condensed table-bordered" style="border:1px solid black">
                                            ...
                                            <tbody>
                                                ...
                                                $undsFalta = 0;
                                                $countPedido = 0;
                                                $consultaSQL = "SELECT pe.num_pedido, pe.cliente, pro.siglas, pe.unds, bo.parcial, bo.finfecha, bo.obs_bodega, bo.numNovedad FROM bodega bo
                                                ...
                                                ?>
                                                    ...
                                                    <tr style="border:1px solid black">
                                                        ...
                                                        <td class="text-uppercase bordes"><?php echo ($pedido['cliente']) ?></td>
                ...
                <div class="collapse show " id="pedidosTresDias" data-parent="#accordionExample">
                    <div class="container">
                        <div class="row row-cols-1 row-cols-md-1">
                            <div class="col mb-4 ">
                ...
                <div class="collapse show " id="pedidosCuatroDias" data-parent="#accordionExample">
                    <div class="container">
                        <div class="row row-cols-1 row-cols-md-1">
                            <div class="col mb-4 ">
                ...
                <div class="table-container collapse  show border rounded" id="calendarioPedidos" data-parent="#accordionExample">
