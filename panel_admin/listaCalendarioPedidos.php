        ...
        <main>
            <div class="container-fluid">
                ...
                <div class="accordion" id="accordionExample">
                    ...
                    <div class="breadcrumb mb-3 mt-3 px-0">
                        <div class="col-xl-3 col-md-6 ">
                            ...
                            <?php
                                ...
                                $unds=$pedidos[0]['unds'];
                                ?>
                                <div class="card-header">Pedidos Vencidos: <?php echo $contar." pedidos.  (".$unds." unds).";?></div>
                        ...
                        <div class="col-xl-3 col-md-6">
                            ...
                            <?php
                                ...
                                $unds=$pedidos[0]['unds'];
                                ?>
                                <div class="card-header">0 a 3 diass: <?php echo $contar." pedidos.  (".$unds." unds).";?></div>
                                <div class="card-footer d-flex align-items-center justify-content-between">
                        ...
                        <div class="col-xl-3 col-md-6">
                            ...
                            <?php
                                ...
                                $unds=$pedidos[0]['unds'];
                                ?>
                                <div class="card-header">4 días en adelante: <?php echo $contar." pedidos.  (".$unds." unds).";?></div>
                                <div class="card-footer d-flex align-items-center justify-content-between">
                        ...
                        <div class="col-xl-3 col-md-6">
                            ...
                            <?php
                                ...
                                $unds=$pedidos[0]['unds'];
                                ?>
                                <div class="card-header">Total: <?php echo $contar." pedidos.  (".$unds." unds).";?></div> 
                                <div class="card-footer d-flex align-items-center justify-content-between">
                                ...
                                <div class="col mb-4 ">
                                    <div class="card h-100 alert-danger">
                                        ...
                                        <div class="card-footer text-uppercase font-weight-bold text-center">
                                            <span class="text-left"><?php echo ($countPedido) ?> Pedidos</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        ...
                        <table class="table table-bordered rounded">
                            ...
                            <thead>
                                ...
                                <tr class="text-center text-uppercase ">
                                    <th class="sticky-left sticky-top"></th>
                                    <th class="sticky-top ">
                                        <h1>Lunes</h1>
                                    </th>
                                    <th class="sticky-top ">
                                                ...
                                                <td>
                                                    <div class="col mb-4 p-0">
                                                        <div class="card h-100  alert-<?php if ($r > 3) {
                                                            ...
                                                            ?>
                                                            <div class="card-header text-center font-weight-bold"><?php if ($dia == $hoy) {
                                                                                                                        echo ($dia) . " (HOY)";
                                                                                                                    } else {
                                                                                                                        echo ($dia);
                                                                                                                    } ?></div>
