            ...
            <div class="container-fluid">
                ...
                <div class="card mb-4">
                    <div class="card-header ">
                        <i class="fas fa-table mr-1"></i> Lista de Pedidos Para Estampación
                    </div>
                    <div class="card-body">
                                ...
                                <form id="formEditarEstampacion" class="" method="POST" novalidate>
                                    ...
                                    <div class="form-row">
                                        <div class="form-group text-center col-md-3">
                                            ...
                                            <select name="arte" id="arte" class="custom-select arte">
                                                <option value=""></option>
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group text-center col-md-3">
                                            ...
                                            <select name="nro_plancha" id="nro_plancha" class="custom-select nro_plancha">
                                                <option value="0"></option>
                                                <option value="1">1</option>
                                                <option value="2">2</option>
                                                <option value="3">3</option>
